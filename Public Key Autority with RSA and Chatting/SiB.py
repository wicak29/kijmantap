...
publicKeyB = str(publicKeyE)+'>'+str(N_Value)
CertificateB = client.service.request(publicKeyB)
CertificateA = ""
...
class client(threading.Thread):
    ...
    def run(self):
        global CertificateA, waktu, IDteman, PUteman, Nteman, deskeyteman
        while not self.stopIt:
            msg = self.mrecv()
            if msg[0]=="[":
                CertificateA = msg
                print "Dapat Certificate ->", CertificateA
